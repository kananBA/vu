...
from .views import DashboardTemplateView, CourseTemplateView, CourseNoticeTemplateView, TaskDetailTemplateView, TaskCreateTemplateView, TaskListTemplateView, CourseStudentDeleteView
